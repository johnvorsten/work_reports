...
ATTRIBUTES_FIELDS = ["point_system_name", "point_name", "point_type", "supervised", "revision_number",
              "classification", "descriptor", "panel_name", "point_address", "text_table",
